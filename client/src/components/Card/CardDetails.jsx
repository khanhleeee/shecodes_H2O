        ...
        {companies.map((c) => (
          <div className="form-card mr-8" key={c.id}>
            <div className="p-4 flex items-center ">
              <img src={c.logo} className="mr-4 w-12 h-12" />
            ...
            <div className="flex-row flex gap-2 px-2">
              <div className="w-[133px] h-[37.54px] px-[9px] ml-3.5 py-[5.77px] bg-white bg-opacity-20 rounded-[23.09px] border border-lime-950 justify-start items-center gap-[2px] inline-flex">
