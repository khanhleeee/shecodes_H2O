			...
			<div className='business-details'>
				...
				<div className='bg-slate-200 w-full h-full'>
					<div className='flex flex-row'>
						<div className='bg-white w-[1000px] h-1250 ml-14 top-5 mt-20 rounded-lg'>
							<div className='flex-row'>
								...
								<div>
									<b className='text-black text-lg ml-9 mt-14 font-bold flex mb-3'>
								...
								<div className='text-black text-base font-normal px-10 mt-1 mb-9'>
									<ul className='list-disc list-inside'>
										...
										<li>
											Ứng dụng sáng tạo công nghệ tương tác vào các
						...
						<div className='w-[410px] h-[560.75px] mt-20 ml-4 px-[74px] py-[38px] bg-white rounded-lg shadow flex-col justify-start items-start gap-3 inline-flex'>
							...
							<div className="self-stretch text-center text-neutral-500 text-xs font-normal font-['Inter'] leading-[18px]">
								Bằng cách nhấp vào Gửi tin nhắn, tôi đồng ý với gửi
								thông tin liên hệ của tôi để lưu trữ thêm và xử lý.
							</div>
						</div>
					</div>

					<div className='flex flex-row'>
						<div className='w-[400px] h-[128px] p-[25px] bg-white rounded-lg shadow flex-col justify-start items-start ml-[56px] mr-6 mt-6 flex'>
					...
					<div className='relative inline-block ml-14 px-4 bg-slate-200 flex-row'>
						<span className='pl-px[20px] inline-block mt-8 text-black text-2xl font-bold mb-4'>
